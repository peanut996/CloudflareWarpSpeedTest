...
var localizer_csv = i18n.Init_i18n("utils/csv")
...
func ExportCsv(data []CloudflareIPData) {
	...
	if err != nil {
		log.Fatalf(i18n.Query_template_i18n(localizer_csv, "Create file {{.Output}} failed：{{.err}}", map[string]interface{}{"Output": Output, "err": err}))
		return
	}
	defer fp.Close()
	w := csv.NewWriter(fp)
